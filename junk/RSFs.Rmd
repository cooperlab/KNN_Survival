...
splitIdxs$train[fold][[1]][[1]][1,]
splitIdxs$valid[fold,]
splitIdxs$test[[fold]][[1]][1,]
...
# training the model
train.obj <- rfsrc(Surv(time, status) ~ ., allInfo, nsplit = nSplitArray[k], nodesize = nodeSizeArray[j], ntree = treeArray[i])
