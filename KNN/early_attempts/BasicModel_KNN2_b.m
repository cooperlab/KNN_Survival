...
%     Alive_valid = TimeIndicator(Survival_valid,Censored_valid,t_min,t_max);
    ...
    for K = K_min:2:K_max
        ...
        Y_valid_hat = KNN_Survival2(X_valid,X_prototype,Survival_prototype,Censored_prototype,K,Beta_init);
...
%     end
    ...
    Alive_test_hat = KNN_Survival2(X_test,X_prototype,Survival_prototype,Censored_prototype,K,Beta_init);
